...
**NOTE - This Kong version is 2.7.1 (open source). Because of this, the only encryptation type supported is MD5. To support SHA-256, I made a modification on Kong and Konga images.**
...
hostssl kong kong 192.168.50.12/32 scram-sha-256 clientcert=0  #conexão Konga
...
#POSTGRES_INITDB_ARGS=--auth-host=scram-sha-256     # database_encryptation. If commented, it'll use MD5
...
KONG_PROXY_LISTEN=0.0.0.0:8002, 0.0.0.0:9443 ssl
...
**NOTE 1 - This step only works if you use md5 encriptation between database and application (Konga is deprecated and if you want to use it, use md5, make a dump and restore it. Doing this, you'll "work around" and avoid problems)**
